...
const DWORD  EXT2_GOOD_OLD_REV = 0;		/* The good old (original) format */
const DWORD  EXT2_DYNAMIC_REV  = 1; 	/* V2 format w/ dynamic inode sizes */
const DWORD  EXT2_GOOD_OLD_INODE_SIZE = 128;
const DWORD  EXT2_GOOD_OLD_FIRST_INO  = 11;
...
const DWORD BRESOLVE_ERROR = 0x01;
const DWORD BRESOLVE_NO_ERROR = 0x02;
